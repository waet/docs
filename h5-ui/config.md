...
```javascript
    ...
    VUE_APP_cmpNo = QHHK //总公司代码

    VUE_APP_addressIp = https://m.qhtxtrip.com //域名

    VUE_APP_addressUrl = https://m.qhtxtrip.com/ser //域名 支付调用

    VUE_APP_logo = qh_df.png  //默认logo 可为空
    VUE_APP_pageName =  庆华天下 // 登录页 title
    VUE_APP_compaySuper = dc4d87bc081247ffaf0befa8bb72d447 //总公司id
...
```javascript
    ...
    API_DEFAULT_CONFIG.URL = {
        ...
        nginx:'https://sfile.qhtxtrip.com' //http://sfile.lingduankeji.com  //静态文件地址 固定加载地址
    }
```
